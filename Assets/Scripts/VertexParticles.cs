//Credit: http://www.gamasutra.com/blogs/MarekStromsky/20150327/239861/Particles_spawned_at_mesh_vertices_Recreating_inFamous_Second_Sons_neon_run_effect_in_Unity3D.php
...
public class VertexParticles : MonoBehaviour
{
	...
	private GameObject _LightParent;
	...
	private void Awake()
	{
		...
		if (spawnLights)
		{
			_LightParent = GameObject.Find("Light Parent");
			if (_LightParent == null)
			{
				_LightParent = new GameObject("Light Parent");
			}
			...
			for (int i = 0; i < lights.Length; i++)
			{
				...
				lights[i].transform.SetParent(_LightParent.transform);	
			}
		}
	}
	...
	private void LateUpdate()
	{
		...
		{
			particlesCreated[i].lifetime = timeDelta * lifetimeStep;
